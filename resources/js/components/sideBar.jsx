            ...
            <div style={{display: "flex", flexDirection: "column", justifyContent: "space-evenly",
                ...
                <div style={{width: "70%", height: "auto", aspectRatio: "1/1", display: "flex", justifyContent: "center", 
                    ...
                    <a style={{display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer",
                        flexDirection: "column", borderRadius: "10px", aspectRatio: "1/1", width: "60px"}}
                        href="/tumama">
                        <svg xmlns="http://www.w3.org/2000/svg" style={{color: "rgba(195, 167, 128, 0.9)"}} width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" class="lucide lucide-calendar-days-icon lucide-calendar-days"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/><path d="M8 14h.01"/><path d="M12 14h.01"/><path d="M16 14h.01"/><path d="M8 18h.01"/><path d="M12 18h.01"/><path d="M16 18h.01"/></svg>
                    </a>
                    <p style={{margin: "0", fontFamily: "Poppins, serif", fontSize: "16px",
                ...
                <div style={{width: "70%", height: "auto", aspectRatio: "1/1", display: "flex", justifyContent: "center", 
                    ...
                    <a style={{display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", backgroundColor: "#f1d99b",
                        flexDirection: "column", borderRadius: "10px", aspectRatio: "1/1", width: "60px"}}
                        href="/recetas">
                        <svg xmlns="http://www.w3.org/2000/svg" style={{color: "rgba(195, 167, 128, 0.9)"}} width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" class="lucide lucide-book-open-icon lucide-book-open"><path d="M12 7v14"/><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"/></svg>
                    </a>
                    <p style={{margin: "0", fontFamily: "Poppins, serif", fontSize: "16px",
                ...
                <div style={{width: "70%", height: "auto", aspectRatio: "1/1", display: "flex", justifyContent: "center", 
                    ...
                    <a style={{display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer",
                        flexDirection: "column", borderRadius: "10px", aspectRatio: "1/1", width: "60px"}}
                        href="/tumama">
                        <svg xmlns="http://www.w3.org/2000/svg" style={{color: "rgba(195, 167, 128, 0.9)"}} width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" class="lucide lucide-archive-icon lucide-archive"><rect width="20" height="5" x="2" y="3" rx="1"/><path d="M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8"/><path d="M10 12h4"/></svg>
                    </a>
                    <p style={{margin: "0", fontFamily: "Poppins, serif", fontSize: "16px",
                ...
                <div style={{width: "70%", height: "auto", aspectRatio: "1/1", display: "flex", justifyContent: "center", 
                    ...
                    <a style={{display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer",
                        flexDirection: "column", borderRadius: "10px", aspectRatio: "1/1", width: "60px"}}
                        href="/tumama">
                        <svg xmlns="http://www.w3.org/2000/svg" style={{color: "rgba(195, 167, 128, 0.9)"}} width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" class="lucide lucide-gift-icon lucide-gift"><rect x="3" y="8" width="18" height="4" rx="1"/><path d="M12 8v13"/><path d="M19 12v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-7"/><path d="M7.5 8a2.5 2.5 0 0 1 0-5A4.8 8 0 0 1 12 8a4.8 8 0 0 1 4.5-5 2.5 2.5 0 0 1 0 5"/></svg>
                    </a>
                    <p style={{margin: "0", fontFamily: "Poppins, serif", fontSize: "16px",
